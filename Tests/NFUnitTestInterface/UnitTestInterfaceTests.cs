...
namespace NFUnitTestInterface
{
    ...
    public class UnitTestInterfaceTests
    {
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("If effective visibility is internal, public iface may have an internal base iface ");
            Debug.WriteLine("(Bug 86453: has some details on this.  But it has to do with class  internal)");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Simplest interface declared in global namespace");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Simplest interface declared in class in default global namespace");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Simple interface declaration with diff types of methods, args, and properties");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Simple interface declaration properties with only gets");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Simple interface declaration properties with only sets");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Verify that an interface can be hidden by 'new' member in derived class");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Simplest form of interface inheritance");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Simplest form of interface inheritance, inheriting multiple interfaces");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Verify that an interface hidden without using new results in warning");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Verify public and internal interfaces declared in global namespace are valid");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Verify public and internal interfaces are valid inside classes");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Verify private and protected interfaces are valid inside classes");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Verify new interface gens warning if not hiding anything");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Verify new interface is valid inside classes when properly hiding an inherited member");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Verify protected internal interfaces are valid inside classes");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Simplest interface declared (with semi-colon) in global namespace");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Simplest interface declared (with semi-colon) in  class in default global namespace");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("A member of an interface-type can be assigned an instance of class that implements it");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Warning gets generated when two methods implement an inherited method");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Using the 'override' keyword allows you to hide previous method implementation");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("A class that implements an interface with method, property, event, and indexer");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Implementing method that was defined identically by two different base-interfaces should work");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Implementing property that was defined identically by two different base-interfaces should work");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Implementing an event that was defined identically by two different base-interfaces should work");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Implementing an indexer that was defined identically by two different base-interfaces should work");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("The members of base class participate in interface mapping");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Two interfaces on the same object must resolve to the same reference");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Interface methods implementation inheritance map as expected (1st/2nd example in 13.4.3)");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Interface methods implementation inheritance (w/virtual) map as expected (3rd/4th example in 13.4.3)");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Explicit interface member implementation of a method");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Explicit interface member implementation of a property");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Explicit interface member implementation of an event (Bug 89766)");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Explicit interface member implementation of an indexer");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Explicitly implemented members (method) can be called through interface instances");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Explicitly implemented members (property) can be called through interface instances");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Explicitly implemented members (indexer) can be called through interface instances");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Explicitly implemented members (event) can be called through interface instances  (Bug 89766)");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Hidden base interface members may be implemented in all of the ways used in this");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Explicitly implementing overloaded methods should work ");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("An abstract class can implement an interface's methods as abstract");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("A class that inherits an interface implementation is permitted to re-implement the interface by including it in the base class list");
            // Known failure
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Inherited public member declarations and inherited explicit interface member declarations participate in the interface mapping process for re-implemented interfaces (Bug 90165)");
            // Known failure
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Interface reimplementation also reimplements the interface's base interfaces.  Verify mapping is done correctly. (90165)");
            Debug.WriteLine("This Test is an expected fail in the baseline, but has passed in recent testing");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("An abstract class is permitted to map base-interface methods onto abstract methods");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("The abstract methods implementing interface methods must be overridden by inheriting classes");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Explicit interface member implementations are permitted to call abstract methods");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Simplest interface indexer declaration (int)");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Simplest interface indexer declaration (String)");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Simplest interface indexer declaration (user-defined struct)");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Interface indexer with multiple parameters in formal-index-parameter-list");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Interface indexer with just get accessor");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Interface indexer with just set accessor");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Using 'new' on an interface member (indexer) that doesn't hide an inherited member should gen warning ");
            Debug.WriteLine("(Related Bug: 86609)");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Using 'new' on an interface member (method) that doesn't hide an inherited member should gen warning (Bug: 86609)");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Using 'new' on an interface member (property) that doesn't hide an inherited member should gen warning (Bug: 86609)");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Member functions of an interface may have same name if they have diff args");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Interface member that is hidden by an inheriting interface (without using new) gens warning");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Interface that inherits 2 other interfaces that have a member with same sig");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Interface member that is hidden by an inheriting interface (using new) works correctly");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Using 'new' on an interface member (event) that doesn't hide an inherited member should gen warning (Bug: 118831)");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Simple Event declaration within an interface");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Inherited members with same sig, from diff interfaces, can be accessed through casting");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Inherited members with same method names but diff args can be accessed by casting");
        ...
        {
            Debug.WriteLine("Section 13.2 Interface members");
            Debug.WriteLine("Inherited members with same method names but diff args should work if arg passed is not ambiguous (Regression bug: 90867)");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Verify private interfaces gen error when declared in global namespace");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Verify protected interfaces gen error when declared in global namespace");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Simple struct implementation of two interfaces");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("A struct that implements an interface also implicitly implements all of the interface's base interfaces");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("A member of an interface-type can be assigned an instance of a struct that implements it");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("A struct that implements an interface with a method, property, event, and indexer");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Implementing a method that was defined identically by two different base-interfaces should work");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Implementing a property that was defined identically by two different base-interfaces should work");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Explicit interface member implementations");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Implementing an iface method in a struct that doesn't list the iface as a base iface but does list a iface that inherits the iface should work");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Multiple base interfaces and explicit interface member implementations work");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Explicitly implemented members (property) can be called through interface instances (Bug 90570)");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Explicitly implemented members (indexer) can be called through interface instances (Bug 90570)");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Explicitly implemented members (event) can be called through interface instances (89766)");
        ...
        {
            Debug.WriteLine("Section 13.4 Interface implementations");
            Debug.WriteLine("Explicitly implementing member from interface not in base-list (but in base-list of a base interface) should work");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Simplest interface declared in a struct in default global namespace");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Simplest interface declared in a struct in a declared namespace");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Verify public and internal interfaces are valid inside structs");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Verify private interfaces are valid inside structs");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Simplest interface declared (with semi-colon) in a struct in default global namespace");
        ...
        {
            Debug.WriteLine("Section 13.1 Interface declarations ");
            Debug.WriteLine("Simplest interface declared (with semi-colon) in a struct in a declared namespace");
        ...
        class Interface_TestClass_impl_04_C : Interface_TestClass_impl_04_I1
        {
            public void F()
            {
                Debug.WriteLine("Interface_TestClass_impl_04_C.F()");
            }
        }
        ...
        class Interface_TestClass_impl_05_C : Interface_TestClass_impl_05_I1
        {
            public void F()
            {
                Debug.WriteLine("Interface_TestClass_impl_05_C.F()");
            }
        }
        class Interface_TestClass_impl_05_D : Interface_TestClass_impl_05_C
        {
            public void F()
            {
                Debug.WriteLine("Interface_TestClass_impl_05_D.F()");
            }
        }
        ...
        class Interface_TestClass_impl_06_C : Interface_TestClass_impl_06_I1
        {
            ...
            {
                Debug.WriteLine("Interface_TestClass_impl_06_C.F()");
            }
        }
        class Interface_TestClass_impl_06_D : Interface_TestClass_impl_06_C
        {
            ...
            {
                Debug.WriteLine("Interface_TestClass_impl_06_D.F()");
            }
        }
        ...
        class Interface_TestClass_implinherit_01_1 : Interface_TestClass_implinherit_01_I1
        {
            public void Paint()
            {
                Debug.WriteLine("Interface_TestClass_implinherit_01_1.Paint()");
            }
        }
        class Interface_TestClass_implinherit_01_2 : Interface_TestClass_implinherit_01_1
        {
            ...
            {
                Debug.WriteLine("Interface_TestClass_implinherit_01_2.Paint()");
            }
        }
        ...
        class Interface_TestClass_implinherit_02_1 : Interface_TestClass_implinherit_02_I1
        {
            ...
            {
                Debug.WriteLine("Interface_TestClass_implinherit_02_1.Paint()");
            }
        }
        class Interface_TestClass_implinherit_02_2 : Interface_TestClass_implinherit_02_1
        {
            ...
            {
                Debug.WriteLine("Interface_TestClass_implinherit_02_2.Paint()");
            }
        }
        ...
        class Interface_TestClass_ifreimp_01_1 : Interface_TestClass_ifreimp_01_I1
        {
            ...
            {
                Debug.WriteLine("Interface_TestClass_ifreimp_01_1.Interface_TestClass_ifreimp_01_I1.Paint()");
        ...
        class Interface_TestClass_ifreimp_01_3 : Interface_TestClass_ifreimp_01_1, Interface_TestClass_ifreimp_01_I1
        {
            public void Paint()
            {
                Debug.WriteLine("Interface_TestClass_ifreimp_01_3.Paint()");
            }
        }
        ...
        class Interface_TestClass_ifreimp_02_2 : Interface_TestClass_ifreimp_02_I1
        {
            ...
            {
                Debug.WriteLine("Interface_TestClass_ifreimp_02_2.Interface_TestClass_ifreimp_02_I1.F()");
                throw new Exception("Incorrect method got called!");
            }

            void Interface_TestClass_ifreimp_02_I1.G()
            {
                Debug.WriteLine("Interface_TestClass_ifreimp_02_2.Interface_TestClass_ifreimp_02_I1.G()");
            }

            public void H()
            {
                Debug.WriteLine("Interface_TestClass_ifreimp_02_2.H()");
                throw new Exception("Incorrect method got called!");
            }

            public void I()
            {
                Debug.WriteLine("Interface_TestClass_ifreimp_02_2.I()");
            }
        }
        class Interface_TestClass_ifreimp_02_1 : Interface_TestClass_ifreimp_02_2, Interface_TestClass_ifreimp_02_I1
        {
            public void F()
            {
                Debug.WriteLine("Interface_TestClass_ifreimp_02_1.F()");
            }

            void Interface_TestClass_ifreimp_02_I1.H()
            {
                Debug.WriteLine("Interface_TestClass_ifreimp_02_1.Interface_TestClass_ifreimp_02_I1.H()");
            }
        }
        ...
        class Interface_TestClass_ifreimp_03_C : Interface_TestClass_ifreimp_03_I3
        {
            ...
            {
                Debug.WriteLine("Interface_TestClass_ifreimp_03_C.Interface_TestClass_ifreimp_03_I2.F()");
            }
            void Interface_TestClass_ifreimp_03_I3.G()
            {
                Debug.WriteLine("Interface_TestClass_ifreimp_03_C.Interface_TestClass_ifreimp_03_I3.G()");
            }
        }
        class Interface_TestClass_ifreimp_03_D : Interface_TestClass_ifreimp_03_C, Interface_TestClass_ifreimp_03_I3
        {
            public void F()
            {
                Debug.WriteLine("Interface_TestClass_ifreimp_03_D.F()");
            }
            public void G()
            {
                Debug.WriteLine("Interface_TestClass_ifreimp_03_D.G()");
            }
        }
        ...
        class Interface_TestClass_namesig_02_c : Interface_TestClass_namesig_02_1
        {
            public void F(int x)
            {
                Debug.WriteLine("F(int x) works!");
            }
            public void F(String x)
            {
                Debug.WriteLine("F(String x) works!");
            }
        }
        ...
        struct Interface_TestClass_struct_impl_04_C : Interface_TestClass_struct_impl_04_I1
        {
            public void F()
            {
                Debug.WriteLine("Interface_TestClass_struct_impl_04_C.F()");
            }
        }
        ...
        class Interface_TestClass_struct_explicit_11
        {
            public static int Main_old()
            {
                try
                {
                    ...
                    Debug.WriteLine((((Interface_TestClass_struct_explicit_11_I1)le).Value).ToString());
                    return 0;
                }
                catch (System.Exception)
                {

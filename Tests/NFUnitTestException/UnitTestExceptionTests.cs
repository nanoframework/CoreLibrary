...
namespace NFUnitTestException
{
    ...
    public class UnitTestExceptionTests
    {
        ...
        {
            Debug.WriteLine("This test will confirm that the the thrown exception is caught by the matching catch, not the base class catch blocks");
            Assert.True(Exc_TestClass_excep02.testMethod());
        }
        [TestMethod]
        public void Exc_excep04_Test()
        {
            Debug.WriteLine("This test will confirm that the the thrown exception is caught and the error code can be set");
            Assert.True(Exc_TestClass_excep04.testMethod());
        }
        [TestMethod]
        public void Exc_excep05_Test()
        {
            Debug.WriteLine("This test will confirm that the the thrown exception is caught by the matching catch, not the base class catch");
            Assert.True(Exc_TestClass_excep05.testMethod());
        }
        [TestMethod]
        public void Exc_excep06_Test()
        {
            Debug.WriteLine("This test will confirm that the the thrown exception is caught by the base class catch");
        ...
        {
            Debug.WriteLine("This test will confirm that the catch() functions.");
            Assert.True(Exc_TestClass_excep09.testMethod());
        }
        [TestMethod]
        public void Exc_excep10_Test()
        {
            Debug.WriteLine("This test will confirm that the thrown exception is handled in the catch()");
            Debug.WriteLine("when no matching catch is available.");
            Assert.True(Exc_TestClass_excep10.testMethod());
        }
        [TestMethod]
        public void Exc_excep11_Test()
        {
            Debug.WriteLine("This test will confirm that the the thrown exception is caught by the matching catch, not the catch()");
            Assert.True(Exc_TestClass_excep11.testMethod());
        }
        [TestMethod]
        public void Exc_excep27_Test()
        {
            Debug.WriteLine("Throwing an exception transfers control to a handler.");
            Assert.True(Exc_TestClass_excep27.testMethod());
        }
        [TestMethod]
        public void Exc_excep28_Test()
        {
            Debug.WriteLine("When an exception is thrown, control is transferred to a handler");
            Assert.True(Exc_TestClass_excep28.testMethod());
        }
        [TestMethod]
        public void Exc_excep30_Test()
        {
            Debug.WriteLine("A throw-expression with no operand rethrows the exception being handled.");
            Assert.True(Exc_TestClass_excep30.testMethod());
        }
        [TestMethod]
        public void Exc_excep31_Test()
        {
            Debug.WriteLine("A throw-expression with no operand does not copy the exception being handled.");
            Assert.True(Exc_TestClass_excep31.testMethod());
        }
        [TestMethod]
        public void Exc_excep33_Test()
        {
            Debug.WriteLine("The exception thrown by a rethrow is the one most recently caught and not finished.");
            Assert.True(Exc_TestClass_excep33.testMethod());
        }
        [TestMethod]
        public void Exc_excep34_Test()
        {
            Debug.WriteLine("When initialization is complete for the formal parameter of a catch clause, an exception is considered caught.");
            Assert.True(Exc_TestClass_excep34.testMethod());
        }
        [TestMethod]
        public void Exc_excep35_Test()
        {
            Debug.WriteLine("A handler is not allowed to catch an expression thrown outside");
            Debug.WriteLine("its function-try-block and any function called from its function-");
            Debug.WriteLine("try-block.");
            Assert.True(Exc_TestClass_excep35.testMethod());
        }
        [TestMethod]
        public void Exc_excep40_Test()
        {
            Debug.WriteLine("If no match is found among the handlers for a try-block, the");
            Debug.WriteLine("search for a matching handler continues in a dynamically");
            Debug.WriteLine("surrounding try-block.");
        ...
        {
            Debug.WriteLine("Handle throws up to 255 levels deep.");
        ...
        {
            Debug.WriteLine("Handle throws up to 255 levels deep, but don't catch.  VM should not die.");
        ...
        {
            Debug.WriteLine("Should get unreachable code warning, but nothing more.");
        ...
        {
            Debug.WriteLine("Any finally clauses associated with try statements will be executed before catch clause execution");
        ...
        {
            Debug.WriteLine("Inner exceptions can be chained");
            Assert.True(Exc_TestClass_excep60.testMethod());
        }
        [TestMethod]
        public void Exc_excep61_Test()
        {
            Debug.WriteLine("Inner exceptions can be chained to arbitrary length");
        ...
        //{
        //    Debug.WriteLine("If a catch search reaches a static ctor then a Exception is thrown,");
        //    Debug.WriteLine("at the point of static ctor invocation. The inner exception is the original exception.");

        //    Debug.WriteLine("an exception thrown in a static constructor brings up a dialog box in Visual Studio.");
        //    Debug.WriteLine("Disable this test so that it doesn't hose VS until it is fixed.");

        //    // TODO: check this
        //    Assert.True(Exc_TestClass_excep63.testMethod());
        //    {
        //        Debug.WriteLine("This is bug number: 21724	Resolved By Design.");
        //        Debug.WriteLine("This is bug number: 21724	If a catch search reaches a static ctor then a Exception is thrown at the point of static ctor invocation. The inner exception is the original exception. ");
        //        Debug.WriteLine("When this bug is fixed change this back to pass and chang eht known failure to fail");
        //    }
        //}
        //[TestMethod]
        //public void Exc_excep64_Test()
        //{
        //    Debug.WriteLine("If a catch search reaches a static field initializer then a Exception is thrown,");
        //    Debug.WriteLine("at the point of static ctor invocation. The inner exception is the original exception.");
        ...
        public class Exc_TestClass_excep01
        {
            ...
            public static int Main_old()
            {
                try
                {
                    Debug.WriteLine("In try block, ready to throw.");
        ...
        public class Exc_TestClass_excep02
        {
            ...
            public static int Main_old()
            {
                ...
                {
                    Debug.WriteLine("In Exc_TestClass_excep02_E1 catch block.");
                    Debug.WriteLine(s.Message);
                    retval = 0;
                }
                catch (Exception)
                {
                    Debug.WriteLine("FAIL - In Exception catch block.");
                    retval = 2;
                }
                //catch (Exception e)
                //{
        ...
        public class Exc_TestClass_excep04
        {
            ...
            public static int Main_old()
            {
                ...
                {
                    Debug.WriteLine("Entering finally block");
                    retval -= 2;
                }
                Debug.WriteLine("Ready to return.");
                if (0 == retval) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL, retval=={0} " + retval.ToString());
                return retval;
            }
            public static bool testMethod()
            {
        ...
        public class Exc_TestClass_excep05
        {
            ...
            public static int Main_old()
            {
                try
                {
                    ...
                    {
                        Debug.WriteLine("FAIL -- Should not enter catch (Exception) block");
                        retval++;
                    }
                }
                finally
        ...
        public class Exc_TestClass_excep10
        {
            ...
            public static int Main_old()
            {
                ...
                {
                    Debug.WriteLine("FAIL -- Should not enter catch (Exception a) block.");
                    retval = 1;
                }
                catch
                {
        ...
        public class Exc_TestClass_excep11
        {
            ...
            public static int Main_old()
            {
                ...
                {
                    Debug.WriteLine("In catch (Exception r) block.");
                    Debug.WriteLine(r.Message);
                    retval -= 1;
                }
                catch
                {
                    Debug.WriteLine("FAIL -- Should not enter catch () block.");
                    retval += 1;
                }
                return retval;
            }
        ...
        public class Exc_TestClass_excep27
        {
            ...
            public static int Main_old()
            {
                ...
                catch (Exception e) { retval -= 5; Debug.WriteLine(e.Message); }
                return retval;
            }
            public static bool testMethod()
            {
        ...
        public class Exc_TestClass_excep28
        {
            ...
            public static int Main_old()
            {
                ...
                if (tossval != 0)
                {
                    Debug.WriteLine("toss(0) returned ");
                    Debug.WriteLine(tossval.ToString());
                    Debug.WriteLine(" instead of 0.");
                }
                else
                {
                    retval -= 4;
                ...
                if (tossval != 1)
                {
                    Debug.WriteLine("toss(1) returned ");
                    Debug.WriteLine(tossval.ToString());
                    Debug.WriteLine(" instead of 1.");
                }
                else
                {
                    retval -= 2;
                ...
                if (tossval != 2)
                {
                    Debug.WriteLine("toss(2) returned ");
                    Debug.WriteLine(tossval.ToString());
                    Debug.WriteLine(" instead of 2.");
                }
                else
                {
                    retval -= 1;
        ...
        public class Exc_TestClass_excep33
        {
            ...
            public static int Main_old()
            {
                ...
                {
                    Debug.WriteLine("Unexpected Exc_TestClass_excep33_E2 catch.");
                }
                catch (Exc_TestClass_excep33_E3)
                {
                    Debug.WriteLine("Unexpected Exc_TestClass_excep33_E3 catch.");
                }
                catch (Exc_TestClass_excep33_E4)
                {
                    Debug.WriteLine("Caught in Exc_TestClass_excep33_E4, as expected.");
                    retval = 0;
                }
                catch
                {
                    Debug.WriteLine("Unexpected ... catch.");
                }
                if (retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL");
                return retval;
        ...
        public class Exc_TestClass_excep34
        {
            ...
            public static int Main_old()
            {
                ...
                {
                    Debug.WriteLine("Unexpected Exc_TestClass_excep34_E2 catch.\n");
                }
                catch (Exc_TestClass_excep34_E3)
                {
                    Debug.WriteLine("Caught in Exc_TestClass_excep34_E3 as expected.\n");
                    retval = 0;
                }
                catch
                {
        ...
        public class Exc_TestClass_excep41_F
        {
            ...
            public void f01()
            {
                try
                {
                    Debug.WriteLine("In f01(), throwing an Exc_TestClass_excep41_E3...");
                    throw new Exc_TestClass_excep41_E3();
                    Debug.WriteLine("After throw in f01().  SHOULD NOT BE HERE!");
                }
                catch (Exc_TestClass_excep41_E1)
                {
                    Debug.WriteLine("In catch in f01()");
                    xpath += 4;
                }
            }
            public void f00()
            {
                try
                {
                    Debug.WriteLine("Calling f01()...");
                    f01();
                    Debug.WriteLine("Returned from f01()");
                }
                catch (Exc_TestClass_excep41_E4)
                {
                    Debug.WriteLine("In catch in f00()");
                    xpath += 2;
                }
            }
        }
        public class Exc_TestClass_excep41
        {
            ...
            public static int Main_old()
            {
                ...
                try
                {
                    Debug.WriteLine("Calling f00()...");
                    f.f00();
                    Debug.WriteLine("Returned from f00()...");
                }
                ...
                if (Exc_TestClass_excep41_F.xpath == 1)
                    retval--;
                if (retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL, xpath=={0} " + (Exc_TestClass_excep41_F.xpath).ToString());
                return retval;
            }
            public static bool testMethod()
            {
        ...
        public class Exc_TestClass_excep42_F
        {
            ...
            public void f255(int i)
            {
                ...
                if (i == 255)
                {
                    Debug.WriteLine("Throwing Exc_TestClass_excep42_E1");
                    tb = 0;
                    throw s;
                }
                else
            ...
            public class Exc_TestClass_excep42
            {
                ...
                public static int Main_old()
                {
                    ...
                    {
                        Debug.WriteLine("Caught Exc_TestClass_excep42_E1");
                        retval = Exc_TestClass_excep42_F.tb;
                    }
                    catch
                    {
                        Debug.WriteLine("Did not catch Exc_TestClass_excep42_E1");
                        retval = -1;
                    }
        ...
        */
        ...
        public class Exc_TestClass_excep42b_F
        {
            ...
            public void f033(int i)
            {
                ...
                if (i == 33)
                {
                    Debug.WriteLine("Throwing Exc_TestClass_excep42b_E1");
                    tb = 0;
                    throw s;
                }
                else
        ...
        public class Exc_TestClass_excep42b
        {
            ...
            public static int Main_old()
            {
                ...
                {
                    Debug.WriteLine("Caught Exc_TestClass_excep42b_E1");
                    retval = Exc_TestClass_excep42b_F.tb;
                }
                catch
                {
                    Debug.WriteLine("Did not catch Exc_TestClass_excep42b_E1");
                    retval = -1;
                }
                Debug.WriteLine(retval.ToString());
                if (retval == 0) Debug.WriteLine("PASS");
        ...
        public class Exc_TestClass_excep58
        {
            ...
            public static int Main_old()
            {
                try
                {
                    ...
                    {
                        Debug.WriteLine("In inner finally block");
                        retval ^= 0x01;
                    }
                }
                ...
                {
                    Debug.WriteLine("In outer finally block");
                    if (0 == (retval & 0x03))
                        retval ^= 0x04;
                }
                if (0 == retval) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL, retval == " + retval.ToString());
                return retval;
            }
            public static bool testMethod()
            {
            ...
            public static int Main_old()
            {
                try
                {
                    try
                    {
                        ...
                        {
                            Debug.WriteLine("In innermost finally block");
                            retval ^= 0x01;
                        }
                    }
                    //catch (Exception s){
                    ...
                    {
                        Debug.WriteLine("In middle finally block");
                        if (0 == (retval & 0x01))
                            retval ^= 0x02;
                    }
                }
        ...
        public class Exc_TestClass_excep60
        {
            ...
            public static int Main_old()
            {
                ...
                catch (Exception s)
                {
                    if (0 == (retval & 0x07))
                        retval ^= 0x08;
                    Debug.WriteLine("In outer catch block.");
                ...
                if (0 == retval) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL, retval == 0x" + retval.ToString());
                return retval;
            }
            public static bool testMethod()
            {
        ...
        public class Exc_TestClass_excep63_SC
        {
            ...
            public static void InitHelper()
            {
                Debug.WriteLine("This is bug number: 21724	Resolved By Design.");
                Debug.WriteLine("This is bug number: 21724	If a catch search reaches a static ctor then a Exception is thrown at the point of static ctor invocation. The inner exception is the original exception. ");
                Debug.WriteLine("When this bug is fixed change remove the comment below.");
        ...
        public class Exc_TestClass_excep65_C1
        {
            ...
            ~Exc_TestClass_excep65_C1()
            {
                ...
                Debug.WriteLine("In// Exc_TestClass_excep65_C1()");
            }
        }
        ...
        public class Derived : Exc_TestClass_excep65_C2
        {
            ~Derived()
            {
                Debug.WriteLine("In ~Derived()");
                DtorHelper();
                Debug.WriteLine("FAIL, did not exit dtor when exception thrown");

    ...
    public class UnitTestDelegatesTests
    {
        ...
        */
        ...
        class Delegate_TestClass_delegate81_A
        {
            ...
            {
                OutputHelper.WriteLine("Delegate_TestClass_delegate81_A.M1: " + i);
            }
            public static void M2(int i)
            {
                OutputHelper.WriteLine("Delegate_TestClass_delegate81_A.M2: " + i);
            }
            public void M3(int i)
            {
                OutputHelper.WriteLine("Delegate_TestClass_delegate81_A.M3: " + i);
            }
        }

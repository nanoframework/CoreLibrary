...
namespace NFUnitTestDelegates
{
    ...
    public class UnitTestDelegatesTests
    {
        ...
        {
            Debug.WriteLine(" Verify that both static and instance methods can be called from delegates.");
            Assert.True(Delegate_TestClass_delegate01.testMethod());
        }
        [TestMethod]
        public void Delegate_delegate02_Test()
        {
            Debug.WriteLine(" Verify that delegate can be initialized to null.");
        ...
        {
            Debug.WriteLine(" Verify that delegate can be assigned by ternary operator.");
        ...
        {
            Debug.WriteLine(" Verify that delegate can be assigned by ternary operator.  Assign null instead of usable value.");
            Assert.True(Delegate_TestClass_delegate06.testMethod());
        }
        [TestMethod]
        public void Delegate_delegate07_Test()
        {
            Debug.WriteLine(" Verify that delegate can be assigned by ternary operator.  Use null instead of a usable value.");
        ...
        {
            Debug.WriteLine(" Verify that delegates can be compared for equality.");
            Assert.True(Delegate_TestClass_delegate09.testMethod());
        }
        [TestMethod]
        public void Delegate_delegate10_Test()
        {
            Debug.WriteLine(" Verify that delegates can be aggregated in arrays and compared for equality.");
            Assert.True(Delegate_TestClass_delegate10.testMethod());
        }
        [TestMethod]
        public void Delegate_delegate11_Test()
        {
            Debug.WriteLine(" Verify that delegates can be members of classes.");
        ...
        {
            Debug.WriteLine(" Make sure a delegate list filled with nulls is detectable as foo == null");
        ...
        {
            Debug.WriteLine(" Verify that delegates can be aggregated using the + operator;");
        ...
        {
            Debug.WriteLine(" Verify that delegates can be removed using the - operator;");
        ...
        {
            Debug.WriteLine("Bug 214780 - async delegates to methods with out parameters don't work");
        ...
        {
            Debug.WriteLine("Verify Delegate with 257 args.  This is because more than 257 causes the");
            Debug.WriteLine("compiler to take a different code path.");
        ...
        {
            Debug.WriteLine(" Verify that both static and instance struct methods can be called from delegates.");
            Assert.True(Delegate_TestClass_delegate30.testMethod());
        }
        [TestMethod]
        public void Delegate_delegate31_Test()
        {
            Debug.WriteLine(" Verify that virtual struct methods can be called from delegates.");
        ...
        {
            Debug.WriteLine("Delegate Invocation using BeginInvoke");
        ...
        */
        ...
        {
            Debug.WriteLine("params modifier should not be considered when matching a delegate with a method");
            Assert.True(Delegate_TestClass_delegate36.testMethod());
        }
        [TestMethod]
        public void Delegate_delegate60_Test()
        {
            Debug.WriteLine("A delegate declaration defines a class that derives from System.Delegate");
            Assert.True(Delegate_TestClass_delegate60.testMethod());
        }
        [TestMethod]
        public void Delegate_delegate62_Test()
        {
            Debug.WriteLine("The compiler is expected to warn that the new keyword id not rquired as we're not hiding an inherited member");
            Assert.True(Delegate_TestClass_delegate62.testMethod());
        }
        [TestMethod]
        public void Delegate_delegate64_Test()
        {
            Debug.WriteLine("Compiler is expected to warn when new is not used when hiding a member delegate of the base class");
            Assert.True(Delegate_TestClass_delegate64.testMethod());
        }
        [TestMethod]
        public void Delegate_delegate65_Test()
        {
            Debug.WriteLine("Make sure delegates can be hidden.");
        ...
        {
            Debug.WriteLine("Two compatible delegate types can be compared for equality.");
        ...
        {
            Debug.WriteLine("Two compatible delegate types can be compared for equality (or inequality).");
        ...
        {
            Debug.WriteLine("Verify equality and inequality after using += and -= on delegates");
        ...
        {
            Debug.WriteLine("Verify ability to call members of System.Delegate on delegate types");
        ...
        {
            Debug.WriteLine("Verify ability to call members of System.Delegate on delegate types");
            Debug.WriteLine("and that ordinality is maintained in concatenated invocation lists");
        ...
        {
            Debug.WriteLine("Verify that ordinality is maintained in concatenated invocation lists");
            Debug.WriteLine("and that the invocation list members are called synchronously");
        ...
        {
            Debug.WriteLine("Verify that ordinality is maintained in concatenated invocation lists");
            Debug.WriteLine("and that the invocation list members are called synchronously and");
            Debug.WriteLine("that ref parameters are modified through the invocation chain.");
        ...
        public void Delegate_delegate79_Test()
        {
            Debug.WriteLine("Verify that ordinality is maintained in concatenated invocation lists");
            Debug.WriteLine("and that the invocation list members are called synchronously and");
            Debug.WriteLine("that out parameters are set by the last member in the invocation chain.");
            Assert.True(Delegate_TestClass_delegate79.testMethod());
        }
        [TestMethod]
        public void Delegate_delegate80_Test()
        {
            Debug.WriteLine("Verify that System.Exceptions not caught in invoked method are bubbled up");
            Debug.WriteLine("and the remaining methods in the invocation list are not invoked.");
            Assert.True(Delegate_TestClass_delegate80.testMethod());
        }
        [TestMethod]
        public void Delegate_delegate81_Test()
        {
            Debug.WriteLine("Sample from section 15.3 of Delegate_TestClass_?_A#LS");
            Assert.True(Delegate_TestClass_delegate81.testMethod());
        }
        [TestMethod]
        public void Delegate_delegate_modifier09_Test()
        {
            Debug.WriteLine("only new, public, private, protected and internal are allowed as modifiers");
        ...
        public class Delegate_TestClass_delegate03
        {
            static public int Main_old()
            {
               ...
               if(Delegate_TestClass_delegate03_2.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL");
        ...
        public class Delegate_TestClass_delegate12_2
        {
            ...
            public void bar() { Debug.WriteLine("bar"); retval -= 0x01; }
        ...
        public class Delegate_TestClass_delegate12
        {
            ...
            static public int Main_old()
            {
                ...
                multifoo += foo;
                multifoo();
                if(Delegate_TestClass_delegate12_2.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL");
        ...
        public class Delegate_TestClass_delegate13
        {
            ...
            static public int Main_old()
            {
                ...
                foo += new Delegate_TestClass_delegate13_1(p.bar);
                foo();
                if(Delegate_TestClass_delegate13_2.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL");
        ...
        {
            public static int retval = 0x03;
            public void bar() { Debug.WriteLine("bar"); retval += 0x10; }
            static public void far()
            {
                Debug.WriteLine("far");
                retval += 0x20;
        ...
        public class Delegate_TestClass_delegate14
        {
            static public int Main_old()
            {
                ...
                if(Delegate_TestClass_delegate14_2.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL");
        ...
        public class Delegate_TestClass_delegate14a
        {
            static public int Main_old()
            {
                ...
                foo();
                if(Delegate_TestClass_delegate14a_2.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL");
        ...
        public class Delegate_TestClass_delegate14b
        {
            static public int Main_old()
            {
                ...
                foo();
                if(Delegate_TestClass_delegate14b_2.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL");
        ...
        public class Delegate_TestClass_delegate14c
        {
            static public int Main_old()
            {
                ...
                foo();
                if(Delegate_TestClass_delegate14c_2.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL");
        ...
        public class Delegate_TestClass_delegate15_2
        {
            ...
            public void bar1() { Debug.WriteLine("bar1"); retval -= 0x01; }
            static public void far1()
            {
                Debug.WriteLine("far1");
                retval -= 0x02;
            }
            public void bar2() { Debug.WriteLine("bar2"); retval -= 10; }
            static public void far2()
            {
                Debug.WriteLine("far2");
                retval -= 20;
            }
        }
        public class Delegate_TestClass_delegate15
        {
            ...
            static public int Main_old()
            {
                ...
                foo();
                if(Delegate_TestClass_delegate15_2.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL");
        ...
        public class Delegate_TestClass_delegate16
        {
            ...
            static public int Main_old()
            {
                ...
                foo();
                if(Delegate_TestClass_delegate16_2.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL");
        ...
        public class Delegate_TestClass_delegate17
        {
            ...
            static public int Main_old()
            {
                ...
                if(Delegate_TestClass_delegate17_2.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL");
        ...
        public class Delegate_TestClass_delegate18_2
        {
            ...
            public void bar1() { Debug.WriteLine("bar1"); retval -= 10; }
            static public void far1()
            {
                Debug.WriteLine("far1");
                retval -= 20;
        ...
        public class Delegate_TestClass_delegate18
        {
            ...
            static public int Main_old()
            {
                ...
                foo();
                if(Delegate_TestClass_delegate18_2.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL");
        ...
        public class Delegate_TestClass_delegate19_2
        {
            ...
            public void bar() { Debug.WriteLine("bar"); retval -= 1; }
            static public void far()
            {
                Debug.WriteLine("far");
                retval -= 2;
        ...
        public class Delegate_TestClass_delegate19
        {
            ...
            static public int Main_old()
            {
                ...
                foo[1]();
                if(Delegate_TestClass_delegate19_2.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL");
        ...
        public class Delegate_TestClass_delegate20
        {
            ...
            static public int Main_old()
            {
                ...
                foo3();
                if(Delegate_TestClass_delegate20_2.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL");
        ...
        public class Delegate_TestClass_delegate21
        {
            ...
            static public int Main_old()
            {
                ...
                foo[0]();
                if(Delegate_TestClass_delegate21_2.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL");
        ...
        public class Delegate_TestClass_delegate23
        {
            ...
            static public int Main_old()
            {
                ...
                foo3();
                if(Delegate_TestClass_delegate23_A.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL, retval==" + Delegate_TestClass_delegate23_A.retval.ToString());
        ...
        public class Delegate_TestClass_delegate24_A
        {
            ...
            public void bar2() { Debug.WriteLine("bar2"); retval -= 4; }
            static public void far2()
            {
                Debug.WriteLine("far2");
                retval -= 8;
        ...
        public class Delegate_TestClass_delegate24
        {
            ...
            static public int Main_old()
            {
                ...
                foo3();
                if(Delegate_TestClass_delegate24_A.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL, retval==" + Delegate_TestClass_delegate24_A.retval.ToString());
        ...
        public class Delegate_TestClass_delegate25
        {
            ...
            static public int Main_old()
            {
                ...
                foo4();
                if(Delegate_TestClass_delegate25_A.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL, retval==" + Delegate_TestClass_delegate25_A.retval.ToString());
        ...
        public class Delegate_TestClass_delegate26
        {
            public static int Main_old(String[] args)
            {
                try
                {
                    ...
                    else Debug.WriteLine("FAIL, i==" + i.ToString());
                    return i;
                }
                catch (System.Exception)
                {
        ...
        public class Delegate_TestClass_delegate66
        {
            ...
            public static int Main_old(String[] args)
            {
                ...
                if (md2 == md1)
                    retval -= 0x02;
                if (0 == retval) Debug.WriteLine("PASS");
                else {Debug.WriteLine("FAIL, 0x{0:X}");
                return retval;
            }
            public static bool testMethod()
            {
        ...
        public class Delegate_TestClass_delegate72
        {
            ...
            static public int Main_old()
            {
                ...
                foo4();
                if(Delegate_TestClass_delegate72_A.retval == 0) Debug.WriteLine("PASS");
                else Debug.WriteLine("FAIL, retval==" + Delegate_TestClass_delegate72_A.retval.ToString());
        ...
        public class Delegate_TestClass_delegate76
        {
            ...
            public double DelegatedMethod1(int intPart, float frac)
            {
                Debug.WriteLine("DelegatedMethod1");
                return intPart + frac + 5;
            }
            public double DelegatedMethod2(int intPart, float frac)
            {
                Debug.WriteLine("DelegatedMethod2");
                return intPart + frac + 10;
            }
            public double DelegatedMethod3(int intPart, float frac)
            {
                Debug.WriteLine("DelegatedMethod3");
                return intPart + frac + 15;
            }
            public double DelegatedMethod4(int intPart, float frac)
            {
                Debug.WriteLine("DelegatedMethod4");
                return intPart + frac + 20;
            }
            public static int Main_old(String[] args)
            {
        ...
        */
        ...
        class Delegate_TestClass_delegate81_A
        {
            ...
            {
                Debug.WriteLine("Delegate_TestClass_delegate81_A.M1: " + i);
            }
            public static void M2(int i)
            {
                Debug.WriteLine("Delegate_TestClass_delegate81_A.M2: " + i);
            }
            public void M3(int i)
            {
                Debug.WriteLine("Delegate_TestClass_delegate81_A.M3: " + i);
            }
        }

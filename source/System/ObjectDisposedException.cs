...
namespace System
{
    ...
    public class ObjectDisposedException : SystemException
    {
        ...
        /// <param name="innerException">The exception that is the cause of the current exception. If innerException is not nullNothingnullptrunita null reference (Nothing in Visual Basic), the current exception is raised in a catch block that handles the inner exception.</param>
